        ...
        <form action="controller.php" method="POST" class="mt-5">
            ...
            <div class="row offset-2">
                <div class="col-md-4">
                    ...
                    <input required placeholder="username" type="text" name="newusername" id="username" class="form-control">
                </div>
                <div class="col-md-4">
                    <label for="password" class="form-label">MySql password</label>
                    <input required placeholder="password" type="password" name="newpassword" id="password" class="form-control">
                </div>
            </div>
            <div class="row mt-4 offset-2">
                <div class="col-md-4">
                    <label for="database" class="form-label">MySql database</label>
                    <input required placeholder="database name" type="text" name="newdatabase" id="database" class="form-control">
                </div>
                <div class="col-md-4">
                    <label for="table" class="form-label">MySql table</label>
                    <input required placeholder="table name" type="text" name="newtable" id="table" class="form-control">
                </div>
            </div>
